...
class RegisterForm(FlaskForm):
    ...
    address = TextAreaField('Address', validators=[DataRequired(), Length(min=10, max=120)], render_kw={'rows': 1})
...
class EditUserProfileForm(FlaskForm):
    ...
    address = TextAreaField('Address', validators=[Length(50, 120)], render_kw={'rows': 1})
